...
<div class="zivi-gallery-grid">
  <div class="zivi-gallery-card">
    <img src="../assets/images/screenshot-main.png" alt="Interface completa do ziviSpaceEcho">
    <p><strong>Interface completa</strong><br>Visão principal em estilo gabinete.</p>
  </div>
  <div class="zivi-gallery-card">
    <img src="../assets/images/screenshot-header.png" alt="Cabeçalho">
    <p><strong>Cabeçalho</strong><br>Identidade do plugin e área superior.</p>
  </div>
  <div class="zivi-gallery-card">
    <img src="../assets/images/screenshot-mode-selector.png" alt="Seletor de modo">
    <p><strong>Seletor de modo</strong><br>12 posições combinando H1, H2, H3 e reverb.</p>
  </div>
  <div class="zivi-gallery-card">
    <img src="../assets/images/screenshot-main-grid.png" alt="Grade principal">
  ...
  <div class="zivi-gallery-card">
    <img src="../assets/images/screenshot-reaper-track.png" alt="Uso em uma trilha do REAPER">
