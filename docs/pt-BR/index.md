...
[Abrir a galeria completa](gallery.md){ .md-button .md-button--primary }

## Comece por aqui

- [Baixe o plugin](download.md)
- [Instale no REAPER](installation.md)
- [Leia o manual completo](manual.md)
- [Consulte a referência de parâmetros](parameters.md)
- [Experimente receitas de desenho sonoro](sound-design.md)
