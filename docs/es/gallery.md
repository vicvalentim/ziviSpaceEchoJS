...
<div class="zivi-gallery-grid">
  <div class="zivi-gallery-card">
    <img src="assets/images/screenshot-main.png" alt="Interfaz completa de ziviSpaceEcho">
    <p><strong>Interfaz completa</strong><br>Vista principal con estilo de gabinete.</p>
  </div>
  <div class="zivi-gallery-card">
    <img src="assets/images/screenshot-header.png" alt="Cabecera">
    <p><strong>Cabecera</strong><br>Identidad del plugin y área superior.</p>
  </div>
  <div class="zivi-gallery-card">
    <img src="assets/images/screenshot-mode-selector.png" alt="Selector de modo">
    <p><strong>Selector de modo</strong><br>12 posiciones combinando H1, H2, H3 y reverb.</p>
  </div>
  <div class="zivi-gallery-card">
    <img src="assets/images/screenshot-main-grid.png" alt="Grilla principal">
  ...
  <div class="zivi-gallery-card">
    <img src="assets/images/screenshot-reaper-track.png" alt="Uso en una pista de REAPER">
